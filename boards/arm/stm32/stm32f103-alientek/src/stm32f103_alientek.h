/****************************************************************************
 * boards/arm/stm32/stm32f103-minimum/src/stm32f103_alientek.h
 *
...
#define GPIO_BTN_USER3    (GPIO_INPUT|GPIO_CNF_INPULLUP|GPIO_MODE_INPUT|\
                           GPIO_EXTI|GPIO_PORTE|GPIO_PIN2)

#define GPIO_BTN_USER4    (GPIO_INPUT|GPIO_CNF_INPULLDWN|GPIO_MODE_INPUT|\
                           GPIO_EXTI|GPIO_PORTA|GPIO_PIN0)

#define MIN_IRQBUTTON     BUTTON_USER1
#define MAX_IRQBUTTON     BUTTON_USER4
...
#define GPIO_INT1         (GPIO_INPUT|GPIO_CNF_INFLOAT|GPIO_PORTA|GPIO_PIN0)
