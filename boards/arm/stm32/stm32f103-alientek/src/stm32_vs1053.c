/****************************************************************************
 * boards/arm/stm32/stm32f103-alientek/src/stm32_vs1053.c
 *
...
#define VS1053_SPI_PORTNO   1   /* On SPI3 */
...
int stm32_vs1053initialize(void)
{
  ...
  spi = stm32_spibus_initialize(VS1053_SPI_PORTNO);
  if (!spi)
    {
